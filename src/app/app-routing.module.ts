...
import { NavbarInfoComponent } from './components/proyects/ims/navbar-info/navbar-info.component';
import { NavbarVErticalInfoComponent } from './components/proyects/ims/navbar-vertical-info/navbar-vertical-info.component';
import { InfoServiciosComponent } from './components/proyects/ims/info-servicios/info-servicios.component';
import { IMSInfoComponent } from './components/proyects/ims/imsinfo/imsinfo.component';
import { NFVInfoComponent } from './components/proyects/ims/nfvinfo/nfvinfo.component';
import { SNMPInfoComponent } from './components/proyects/ims/snmpinfo/snmpinfo.component';
import { VIMSInfoComponent } from './components/proyects/ims/v-imsinfo/v-imsinfo.component';
import { UDCInfoComponent } from './components/proyects/ims/udcinfo/udcinfo.component';
import { InfoRendComponent } from './components/proyects/ims/info-rend/info-rend.component';
...
const routes: Routes = [
  ...
  {path: 'proyects', component: ProyectsComponent },
    {path: 'ims', component: IMSComponent },
      ...
      {path: 'ims/navbar-info', component:NavbarInfoComponent},
      {path: 'ims/navbar-Vertical-info', component:NavbarVErticalInfoComponent},
      {path: 'ims/info-servicios', component: InfoServiciosComponent},
      {path: 'ims/imsInfo', component: IMSInfoComponent},
      {path: 'ims/NFVInfo', component: NFVInfoComponent},
      {path: 'ims/SNMPInfo', component: SNMPInfoComponent},
      {path: 'ims/vIMSInfo', component: VIMSInfoComponent},
      {path: 'ims/UDCInfo', component: UDCInfoComponent},
      {path: 'ims/InfoRend', component: InfoRendComponent},
